...
<p align="center">
  ...
  <br>
  <a href="https://github.com/MasterShad0w/Shadow-Storage-Bot/stargazers">
    <img src="https://img.shields.io/github/stars/MasterShad0w/Shadow-Storage-Bot?style=social">
  </a>
  <a href="https://github.com/MasterShad0w/Shadow-Storage-Bot/fork">
    <img src="https://img.shields.io/github/forks/MasterShad0w/Shadow-Storage-Bot?label=Fork&style=social">
  </a>  
</p>
...
**If you need any more modes in repo or If you find out any bugs, mention in [@ShadowKing9o ](https://www.telegram.dog/ShadowKing9o)**
...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/MasterShad0w/Shadow-Storage-Bot)</br>
...
#### Deploy in your VPS
````bash
git clone https://github.com/MasterShad0w/Shadow-Storage-Bot
cd File-Sharing-Bot
...
* `CUSTOM_CAPTION` put your Custom caption text if you want Setup Custom Caption, you can use HTML and <a href='https://github.com/MasterShad0w/Movie-Adda-Storage/blob/main/README.md#custom_caption'>fillings</a> for formatting (only for documents)
...
## Support   
Join Our [Support Group](https://www.telegram.dog/ShadowsArena) For Support/Assistance And Our [Movie Addaa](https://t.me/+9Zhp_GdQVctiNjc1) For Latest Movies.   
...
[Shadow-Storage-Bot](https://github.com/MasterShad0w/Shadow-Storage-Bot/) is Free Software: You can use, study share and improve it at your
